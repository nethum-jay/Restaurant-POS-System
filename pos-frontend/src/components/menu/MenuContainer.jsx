        ...
        return (
          ...
          >
            <div className="flex items-start justify-between w-full">
              ...
              <button className="bg-[#2e4a40] text-[#2eca3a] p-2 rounded-lg "><FaShoppingCart size={20} /></button>
            </div>
            <div className="flex items-center justify-between w-full">
              <p className="text-[#f5f5f5] text-xl font-bold">
                Rs.{menu.price}
              </p>
              <dev className="flex items-center justify-between bg-[#1f1f1f] px-4 py-3 
              rounded-lg gap-6 z-20 w-[50%]">
              <button 
